...
git remote add origin https://github.com/nhklogistics2-byte/Trend-crafters.git 2>nul
git remote set-url origin https://github.com/nhklogistics2-byte/Trend-crafters.git
echo Adding files...
git add .
